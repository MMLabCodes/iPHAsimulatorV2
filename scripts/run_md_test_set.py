"""Run the multi-system PHA MD benchmark workflow.

The notebook in ``notebooks/10_batch_md_benchmark.ipynb`` launches this script.
Keep benchmark automation here so the notebook remains a log, launcher, and
progress checker.
"""
...
from iphasimulator.parameterization.gaff2 import (  # noqa: E402
    AmberToolsError,
    parameterize_gaff2,
)
from iphasimulator.simulation.gromacs_runner import (  # noqa: E402
    prepare_gromacs_run_folder,
    write_gromacs_solvation_files,
)
from iphasimulator.simulation.openmm_amber_runner import (  # noqa: E402
    OpenMMRunnerError,
    openmm_available,
...
def discover_targets(system_names: tuple[str, ...]) -> list[BenchmarkTarget]:
